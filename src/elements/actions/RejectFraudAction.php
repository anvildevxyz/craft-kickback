...
class RejectFraudAction extends ElementAction
{
    public function getTriggerLabel(): string
    {
        return Craft::t('kickback', 'Reject (confirm fraud)');
    }

    public function getConfirmationMessage(): ?string
    {
        return Craft::t('kickback', 'Are you sure you want to reject the selected flagged referrals? Their commissions will be cancelled.');
    }
    ...
    public function performAction(ElementQueryInterface $query): bool
    {
        ...
        foreach ($query->all() as $element) {
            ...
            if ($record !== null && $fraud->rejectFlaggedReferral($record)) {
                $success++;
            }
        }
